...
CREATE TABLE BEWERBUNG (
	...
	NACHNAME VARCHAR(255),
	GEBURTSDATUM VARCHAR(255),
	geschlecht_Id BIGINT,
	pflegekind BOOLEAN,
	immunisierung_Masern_Id BIGINT,
	wohnhaft_Bei_Id BIGINT,
	...
	betreuungswunsch_Zeit_Id BIGINT,
	betreuungsform_Id BIGINT,
	...
	but_Id VARCHAR(255),
	but_Verwendungszweck_Id BIGINT,
	kita_Id BIGINT,
