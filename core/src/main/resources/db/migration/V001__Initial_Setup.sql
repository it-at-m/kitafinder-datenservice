...
CREATE TABLE SORGEBERECHTIGTER (
    ...
    GEPLANTE_AUFNAHME_BERUFSTAETIGKEIT_AB VARCHAR(255),
    GEPLANT_AUFNAHME_AUSBILDUNG BOOLEAN,
    GEPLANT_AUFNAHME_AUSBILDUNG_AB VARCHAR(255),
    GEPLANT_AUFNAHME_STUDIUM BOOLEAN,
    GEPLANT_AUFNAHME_STUDIUM_AB VARCHAR(255),
    ...
    ARBEITSUCHEND_SEIT VARCHAR(255),
